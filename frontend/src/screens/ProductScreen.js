      ...
      {loading ? (
        ...
        <>
          ...
          <Row>
            <Col md={6}>
              <h2>Yorumlar</h2>
              {product.reviews.length === 0 && <Message>Mesaj Yok</Message>}
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  ...
                  {userInfo ? (
                    ...
                    <Message>
                      Lütfen <Link to="login">Giriş Yap</Link>'tıktan sonra
                      yorum yazın{" "}
                    </Message>
                  )}
                </ListGroup.Item>
